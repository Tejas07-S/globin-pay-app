...
//
// Why kebab-case values: keeps testIDs consistent and greppable across the
// codebase, and matches common CSS-attribute-style selector conventions used
// by E2E test tooling (Detox, Playwright, etc).
